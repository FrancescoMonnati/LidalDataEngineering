# LIDAL Data Management

This repository contains a Python-based pipeline for the automated processing of data from LIDAL (Light Ion Detector for ALtea), a particle radiation detector operating aboard the International Space Station (ISS).

The system performs key data engineering tasks, including:
